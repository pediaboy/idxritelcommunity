...
<div class="section">
  <div class="info-box">
    <strong style="color: var(--text)">Pagination:</strong> All list endpoints support <code>limit</code> (default 50, max 500) and <code>offset</code>. 
    Add <code>?total=1</code> to include total count in response.
  </div>
</div>
...
<div class="section">
  ...
  <div class="endpoints">
    ...
    <div class="ep">
      ...
      <span class="params">Server health check</span>
    </div>
...
<div class="section">
  ...
  <div class="developer">
    ...
    <div>
      ...
      <div class="dev-contact">WhatsApp: 082218723401 &nbsp;·&nbsp; ritelcommunity.id</div>
    </div>
  </div>
</div>

<footer>
  &copy; 2026 ritelcommunity.id &nbsp;·&nbsp; IDX API v0.1.0 &nbsp;·&nbsp; Data sourced from Bursa Efek Indonesia
</footer>
  ...
  return Response.json(
    {
      ...
      base_url: 'https://api-production-5c86.up.railway.app'
    },
